...
public class eje10{
	public static void main(String[] args){
        ...
        System.out.println("Este programa te dira tu horoscopo");
        System.out.println("Por favor, introduzca el mes de tu nacimiento: ");
        int mes= sc.nextInt();
        System.out.println("Por favor, introduzca el dia de tu nacimiento: ");
        int dia = sc.nextInt();      
        if(dia>31 || mes>12){
